...
1. Run the Apache Web Server and put all files into folder “htdocs”.
2. Open a webpage and enter url  “http://localhost/search.php”
3. Now you can try any query term, i.e. Los Angeles.
